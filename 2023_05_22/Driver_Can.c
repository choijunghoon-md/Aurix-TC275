...
{
    const uint32 dataLow  = 0x12340000;             //msg data[0]에 넣을 데이터
    const uint32 dataHigh = 0x9abc0000;             //msg data[1]에 넣을 데이터
...
{
    IfxMultican_Message msg;
    const unsigned dataLow = message->Data[0]|(message->Data[1]<<8)|(message->Data[2]<<16)|(message->Data[3]<<24);  //데이터를 합쳐서 msg data[0]에 넣을 데이터
    const unsigned dataHigh = message->Data[4]|(message->Data[5]<<8)|(message->Data[6]<<16)|(message->Data[7]<<24); //데이터를 합쳐서 msg data[1]에 넣을 데이터
