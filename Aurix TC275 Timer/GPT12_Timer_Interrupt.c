...
#define RELOAD_VALUE                977u                  /* Reload value to have an interrupt each 500ms    48828u     */
...
void initGpt12Timer(void)
{
    ...
    IfxGpt12_T3_setTimerDirection(&MODULE_GPT120, IfxGpt12_TimerDirection_up);    /* Set T3 count direction       */
...
{
    IfxGpt12_T3_setTimerValue(&MODULE_GPT120, RELOAD_VALUE_10ms);
