...
#define b1     &MODULE_P22,0
#define b2     &MODULE_P22,1
#define b3     &MODULE_P22,2
#define b4     &MODULE_P21,0
#define b5     &MODULE_P22,3
#define b6     &MODULE_P21,4
#define b7     &MODULE_P21,5
#define b8     &MODULE_P20,10
...
void pinmode_in(void){
    IfxPort_setPinMode(b1, IfxPort_Mode_inputPullUp);
    IfxPort_setPinMode(b2, IfxPort_Mode_inputPullUp);
    IfxPort_setPinMode(b3, IfxPort_Mode_inputPullUp);
    IfxPort_setPinMode(b4, IfxPort_Mode_inputPullUp);
    IfxPort_setPinMode(b5, IfxPort_Mode_inputPullUp);
    IfxPort_setPinMode(b6, IfxPort_Mode_inputPullUp);
    IfxPort_setPinMode(b7, IfxPort_Mode_inputPullUp);
    IfxPort_setPinMode(b8, IfxPort_Mode_inputPullUp);
    for(int i=0; i<8; i++){
            aec[i]=0;
            aec_a[i]=0;
        }
...
int indata(void){
    ...
    if(IfxPort_getPinState(b1)==0){aec_a[0]=1;}else{aec_a[0]=0;}
    if(IfxPort_getPinState(b2)==0){aec_a[1]=2;}else{aec_a[1]=0;}
    if(IfxPort_getPinState(b3)==0){aec_a[2]=4;}else{aec_a[2]=0;}
    if(IfxPort_getPinState(b4)==0){aec_a[3]=8;}else{aec_a[3]=0;}
    if(IfxPort_getPinState(b5)==0){aec_a[4]=16;}else{aec_a[4]=0;}
    if(IfxPort_getPinState(b6)==0){aec_a[5]=32;}else{aec_a[5]=0;}
    if(IfxPort_getPinState(b7)==0){aec_a[6]=64;}else{aec_a[6]=0;}
    if(IfxPort_getPinState(b8)==0){aec_a[7]=128;}else{aec_a[7]=0;}
