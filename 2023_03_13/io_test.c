...
int indata(void){
    ...
    if(IfxPort_getPinState(a1)==0){aec_a[0]=0;}else{aec_a[0]=1;}
    if(IfxPort_getPinState(a2)==0){aec_a[1]=0;}else{aec_a[1]=2;}
    if(IfxPort_getPinState(a3)==0){aec_a[2]=0;}else{aec_a[2]=4;}
    if(IfxPort_getPinState(a4)==0){aec_a[3]=0;}else{aec_a[3]=8;}
    if(IfxPort_getPinState(a5)==0){aec_a[4]=0;}else{aec_a[4]=16;}
    if(IfxPort_getPinState(a6)==0){aec_a[5]=0;}else{aec_a[5]=32;}
    if(IfxPort_getPinState(a7)==0){aec_a[6]=0;}else{aec_a[6]=64;}
    if(IfxPort_getPinState(a8)==0){aec_a[7]=0;}else{aec_a[7]=128;}
