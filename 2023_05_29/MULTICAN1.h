...
#define WAIT_TIME_40ms              40                          // 40ms시간
...
void transmitCanMessage(void); //메세지 보내기 (TX 작동)함수
void initLed(void); //LED 핀 설정 함수
void blinkLED1(void); //LED1 꼈다 키는 함수
void blinkLED2(void); //LED2 꼈다 키는 함수
